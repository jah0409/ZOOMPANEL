...
notebook = {
    "cells": [
        ...
        },
        {
            ...
            "metadata": {},
            "source": [
                "**Finally, configure your meeting details and run the bot coordinator!**\n",
                "\n",
                "Change `MEETING_URL`, `PASSCODE`, and `STAY_MINUTES` as needed."
            ]
        },
        {
            "cell_type": "code",
            ...
            "source": [
                ...
                "    MEETING_URL = f\"https://zoom.us/wc/{meeting_id}/join{pwd_param}\"\n",
                "\n",
                "async def run_bots():\n",
                "    joined_event = asyncio.Event()\n",
